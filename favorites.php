...
<body>
    ...
    <div class="row top">
        <h2 style="font-weight:bold;"> My Favorite Recipes</h2>
    </div>
    ...
    <div class="row recipes">
        ...
        <?php
            ...
            $sql = "SELECT * FROM recipe WHERE recipe_id IN (SELECT recipe_id FROM favorites WHERE user_id = ?)";
